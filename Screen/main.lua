...
local function createUI()
    ...
    local disclaimer = display.newText( group, "NB! The borders extend beyond the screens to make them easier to see. Their center points are on the edges.", screen.safe.minX + 20, safe_tooltip.y + safe_tooltip.height + 12, 400, 0, native.systemFont, 20 )
